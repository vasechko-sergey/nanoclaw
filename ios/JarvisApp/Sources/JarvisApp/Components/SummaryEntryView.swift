...
///
/// The day's numbers deliberately do NOT live here. They were put on this
/// capsule once (build 1.36.0) and read as foreign: this is a button, and a
/// button carrying three metrics is neither. They belong in the short view of
/// the agent card that owns them — `StateBoardView`'s metric chips — where the
/// same tap already takes you.
